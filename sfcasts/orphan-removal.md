...
To make it stand out, I'll make this a *crucial* item for any space voyage: "Toilet
Paper." Yes, a cheeky nod to pandemic times. Yuck!
...
object, but it's bundled up inside *another*x object called a proxy.
...
It blows up with our favorite: `starship_id` cannot be null. 
