...
forgotten your ABCs. It's just that Postgres is a
case-sensitive database. So the uppercase T apparently comes before lowercase
...
search for `starship_part`, there are 5 extra queries for the parts for *each*
starship.
